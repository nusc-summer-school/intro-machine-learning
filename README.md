...
This workshop comprehensively introduces machine learning concepts and practical implementation using Python and scikit-learn. Participants will learn how to apply various machine learning algorithms to solve real-world problems.
...
- 10:45 - 12:15: Data Preprocessing and Exploratory Analysis
...
You can run the workshop notebooks directly in Google Colab without any local installation:

1. Visit [Google Colab](https://colab.research.google.com/)
2. Go to File → Open notebook → GitHub
3. Enter the repository URL: https://github.com/nusc-summer-school/intro-machine-learning
4. Select the notebook you want to open

### Option 3: Using pip and virtualenv
...
1. **Housing Price Dataset**: Regression task to predict housing prices
2. **Iris Flower Dataset**: Classification task to identify flower species
3. **Customer Segmentation Dataset**: Clustering task to identify customer groups
...
- **Dr. Sarah Johnson** - Machine Learning Specialist, University of Greenwich
